...
2. Defina a variável JAVA\_HOME apontando para a pasta onde o jdk está instalado, caso não exista (de forma genérica mas sem garantia que funcione, tente: `set JAVA\_HOME=C:\\Arquivos de Programas\\Java\\jdk1.8.0_60`);
